...
internal val FailedToReadKsnFileError = ForageApiResponse.Failure(
    500,
    "client_error",
    "Failed to read KSN file."
)

internal val EncryptionKeyGenerationError = ForageApiResponse.Failure(
    500,
    "client_error",
